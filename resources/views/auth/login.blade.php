                 ...
                 <form class="form-horizontal" role="form" method="POST" action="{{ url('/login') }}">
                            ...
                            <div class="inner-addon right-addon">
                                <div class="col-md-12 input-group-lg">
                                    ...
                                    <input type="email" value="{{isDemo() ? 'demo@test.com' : ''}}" class="form-control" style="border-radius: 4px; box-shadow:0px 2px 4px rgba(0,0,0,0.18); padding-right:40px; " name="email" value="{{ old('email') }}" placeholder="E-mail address">
                            ...
                            <div class="inner-addon right-addon">
                                ...
                                <i class="fa fa-lock" aria-hidden="true"></i>
                                    <input type="password" class="form-control" value="{{isDemo() ? '12345678' : ''}}"  style="border-radius: 4px; box-shadow:0px 2px 4px rgba(0,0,0,0.18);" name="password" placeholder="Password">
                                </div>
                            </div>
                        </div>
